...
builder.Services.AddTransient<IGenericCRUDService<EmployeeModel>, EmployeeCRUDService>();
builder.Services.AddTransient<IGenericCRUDService<AddressModel>, AddressCRUDService>();
